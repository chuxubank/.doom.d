...
**** Install tools
#+begin_src sh
  sudo pacman -S git github-cli fd ripgrep sqlite xdg-utils mailcap base-devel texlive-core texlive-langchinese librime poppler-data aspell aspell-en texlab
#+end_src
