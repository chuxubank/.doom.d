...
***** Install tools
#+begin_src sh
  sudo pacman -S git github-cli fd ripgrep sqlite xdg-utils mailcap base-devel texlive-core texlive-pictures texlive-langchinese librime poppler-data aspell aspell-en texlab graphviz
#+end_src
